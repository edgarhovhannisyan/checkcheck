...
; (function () {
  ...
  function isTouchDevice() {
    //console.log('isTouchDevice fired')
  ...
  function constructor(containerElOrString, config) {
    ...
    function touchmoveWindow(evt) {
      ...
      // prevent screen from scrolling (commented out, as I use my own preventer)
      //evt.preventDefault()
    ...
    function addEvents() {
      ...
      // touch drag  (commented out, as sometimes isTouchDevice is not working properly)
      // if (isTouchDevice()) {
